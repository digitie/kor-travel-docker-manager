...
TRIPMATE_AGENT_POSTGRES_DB="${TRIPMATE_AGENT_POSTGRES_DB:-tripmate_agent}"
...
ensure_database "$TRIPMATE_AGENT_POSTGRES_DB" "$POSTGRES_USER"
...
ensure_postgis_db "$TRIPMATE_AGENT_POSTGRES_DB" "$POSTGRES_USER"
