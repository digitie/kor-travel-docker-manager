...
def test_current_release_is_exact_map_and_pinvi_v5_authority() -> None:
    ...
    assert release.source_for("pinvi").revision == "69a5ac65142e4aa0ba54111ce4edfea70b7d7520"
...
def test_pinset_digest_uses_stable_canonical_compact_json() -> None:
    ...
    assert canonical_pinset_bytes(version=release.version, sources=release.sources) == (
        ...
        b'{"revision":"69a5ac65142e4aa0ba54111ce4edfea70b7d7520",'
    ...
    assert canonical_pinset_sha256(version=release.version, sources=release.sources) == (
        "030b12fc92988617fb955d8b62e14a25939a678de8c3ae79119dd7b3ce70037c"
    )
    assert release.pinset_sha256 == "030b12fc92988617fb955d8b62e14a25939a678de8c3ae79119dd7b3ce70037c"
