...
def test_current_release_is_exact_map_and_pinvi_v5_authority() -> None:
    ...
    assert release.source_for("map").revision == "cc81081ff2e540a6ad9c428a296515e1d79bc316"
    assert release.source_for("pinvi").revision == "10efb21ad84b23db2eeb6d09856cda16d3337822"
...
def test_pinset_digest_uses_stable_canonical_compact_json() -> None:
    ...
    assert canonical_pinset_bytes(version=release.version, sources=release.sources) == (
        b'{"sources":[{"revision":"cc81081ff2e540a6ad9c428a296515e1d79bc316",'
        b'"role":"map","url":"https://github.com/digitie/kor-travel-map.git"},'
        b'{"revision":"10efb21ad84b23db2eeb6d09856cda16d3337822",'
    ...
    assert canonical_pinset_sha256(version=release.version, sources=release.sources) == (
        "cb8d15591480111d7f4cd70398ad46b129e814ad3b9375dfa0fc83562b366752"
    )
    assert release.pinset_sha256 == "cb8d15591480111d7f4cd70398ad46b129e814ad3b9375dfa0fc83562b366752"
