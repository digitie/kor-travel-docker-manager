...
| **T-VN-41-F1D-D** | 최종 스키마 데이터 수용 검증 및 인수 기록 (issue #136) | `[/]` | - | C3 재구성 완료. Map RC 재고정 뒤 외부 Compose lease/정지 확인과 세 standalone dump scratch restore 증적을 먼저 남기고, 별도 원천/ETL 재적재 뒤 데이터 의존 E2E 결과를 기록 |
