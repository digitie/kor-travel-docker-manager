...
def test_current_release_is_exact_map_and_pinvi_v5_authority() -> None:
    ...
    assert release.source_for("map").revision == "e76ad34d19d4e59e97452ae0412e24cfa8f3950a"
...
def test_pinset_digest_uses_stable_canonical_compact_json() -> None:
    ...
    assert canonical_pinset_bytes(version=release.version, sources=release.sources) == (
        b'{"sources":[{"revision":"e76ad34d19d4e59e97452ae0412e24cfa8f3950a",'
    ...
    assert canonical_pinset_sha256(version=release.version, sources=release.sources) == (
        "f27c2763f52278383f5da811090cd38d6da63688bf2bb40c3d55344f2d66e735"
    )
    assert release.pinset_sha256 == "f27c2763f52278383f5da811090cd38d6da63688bf2bb40c3d55344f2d66e735"
