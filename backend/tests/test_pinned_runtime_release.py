...
def test_current_release_is_exact_map_and_pinvi_v5_authority() -> None:
    ...
    assert release.source_for("map").revision == "b981809750b56dd01574d035dcc6596fb999f477"
...
def test_pinset_digest_uses_stable_canonical_compact_json() -> None:
    ...
    assert canonical_pinset_bytes(version=release.version, sources=release.sources) == (
        b'{"sources":[{"revision":"b981809750b56dd01574d035dcc6596fb999f477",'
    ...
    assert canonical_pinset_sha256(version=release.version, sources=release.sources) == (
        "f946bdfa0d906456aa8883b2c5cb524b31f09c22eb1eead8bcc11c47e07de2fb"
    )
    assert release.pinset_sha256 == "f946bdfa0d906456aa8883b2c5cb524b31f09c22eb1eead8bcc11c47e07de2fb"
